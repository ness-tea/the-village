...
namespace UnitySampleAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
	    ...
	    private DialogueManager dMan;
            ...
            {
                if (CrossPlatformInputManager.GetButton("Fire1") && !dMan.dialogueActive)
                {
	...
	private DialogueManager dMan;
        ...
        private void Update()
        {
            ...
            if (CrossPlatformInputManager.GetButtonDown("Jump") && !jump && !dMan.dialogueActive)
            {
                jump = true;
            }
        }
        ...
        private void FixedUpdate()
        {
            ...
            if ((input.x != 0 || input.y != 0) && (advancedSettings.airControl || isGrounded) && !dMan.dialogueActive)
            {
            ...
            if (isGrounded && !dMan.dialogueActive)
            {
                RigidBody.drag = 5f;
